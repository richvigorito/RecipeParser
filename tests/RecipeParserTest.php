...
class RecipeParserTest extends PHPUnit_Framework_TestCase {
    ...
    public function lexemeMatches()
    {
        return array(
          ...
          array("2 small cokes"," cokes",1,null,"1 cokes"),
          array("little apple","apple",.5,null,"0.5 apple"),
          array(" medium coke"," coke",1,null,"1 coke"),
          array("rice","rice",1,null,"1 rice"),
          array("2 large cokes"," cokes",2.5,null,"2.5 cokes"),
          ...
          array("large coke"," coke",1.25,null,"1.25 coke"),
          array("extra large coke"," coke",1.5,null,"1.5 coke"),
          array("sm. soda"," soda",0.5,null,"0.5 soda"),
          array("really big chocolate chip cookie"," chocolate chip cookie",1.5,null,"1.5 chocolate chip cookie"),
          array("2 really big chocolate chip cookie"," chocolate chip cookie",3,null,"3 chocolate chip cookie"),
          ...
          array("2 large pumpkin crispbreads"," pumpkin crispbreads",2.5,null,"2.5 pumpkin crispbreads"),
          ...
          array("2 corn tortillas"," corn tortillas",2,null,"2 corn tortillas"),
          array("1 greek yogurt"," greek yogurt",1,null,"1 greek yogurt"),
          array("2 mcdonalds cheeseburgers"," mcdonalds cheeseburgers",2,null,"2 mcdonalds cheeseburgers"),
          array("chocolate chip cookies"," chocolate chip cookies",1,null,"1 chocolate chip cookies"),
          ...
          array("1/2 mango"," mango",0.5,null,"0.5 mango"),
          ...
          array("wheat thins"," wheat thins",1,null,"1 wheat thins"),
          array("15 golden raisin"," golden raisin",15,null,"15 golden raisin"),
          ...
          array("hot and sour soup"," hot and sour soup",1,null,"1 hot and sour soup"),
          array("1/2 red pepper"," red pepper",0.5,null,"0.5 red pepper"),
	  ...
	  array("tea" , "tea", 1,null,"1 tea"), 
	  array("1 nakd bar" , "nakd bar", 1,null,"1 nakd bar"), 
	  array("6g Marmite" , "Marmite", 6,"g.","6 g. Marmite"), 
	  array("1c spaggetti squash" , "spaggetti squash", 1,"cup","1 cup spaggetti squash"), 
	  array("kale spinach and mango smoothie" , "kale spinach and mango smoothie", 1,null,"1 kale spinach and mango smoothie"), 
	 ...
	 array("1 packet (2 mg) kool-aid", "kool-aid", 2,"mg.","2 mg. kool-aid"), 
	  ...
	  array("2 boxes (50 ounCes) mac n cheese", "mac n cheese", 100,"oz.","100 oz. mac n cheese"), 
	 	array("1/2. Grated carrot", "Grated carrot", .5,null,"0.5 Grated carrot"), 
	 	array("1egg", "egg", 1,null,"1 egg"), 
	 	array("1green onion", "green onion", 1,null,"1 green onion"), 
	 	...
	 	array("2 tiny pears", "pears", 1,null,"1 pears"), 
	 	...
	 	array("double shot latte", "shot latte", 2,null,"2 shot latte"), 
	 	array("4 triple shot latte", "shot latte", 12,null,"12 shot latte"), 
	 	array("2 quadruple shot latte", "shot latte", 8,null,"8 shot latte"), 
	 	array("half beer", "beer", .5,null,"0.5 beer"), 
	 	array("quarter beer", "beer", .25,null,"0.25 beer"), 
	 	array("forth beer", "beer", .25,null,"0.25 beer"), 
	 	array("fifth beer", "beer", .2,null,"0.2 beer"), 
	 	array("third beer", "beer", .33,null,"0.33 beer"), 
	 	array("5 half beer", "beer", 2.5,null,"2.5 beer"), 
	 	array("2x latte", "latte", 2,null,"2 latte"), 
	 	array("3x latte", "latte", 3,null,"3 latte"), 
	 	array("4x latte", "latte", 4,null,"4 latte"), 
	 	array("2 4x latte", "latte", 8,null,"8 latte"), 
	 	array(".2x latte", "latte", .2,null,"0.2 latte"), 
	 	array(".25x latte", "latte", .25,null,"0.25 latte"), 
	 	array(".33x latte", "latte", .33,null,"0.33 latte"), 
	 	array(".5x latte", "latte", .5,null,"0.5 latte"), 
	 	array("5 .5x latte", "latte", 2.5,null,"2.5 latte"), 
